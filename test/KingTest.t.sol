...
contract Exp is Test {
    ...
    function setUp() public {
        ...
        if (chainId == 31337) {
            ...
            contractInstance = IKing(address(new King{value: inicialPrize}()));
            vm.stopPrank();
    ...
    // forge test --mt testToBeKing -vvvv
    // forge test --mt testToBeKing --fork-url $SEPOLIA_RPC_URL -vvvvv
    // forge inspect src/King.sol storage
    ...
    function printInfo(address _addr) public view returns (address owner, uint256 prize, address king) {
...
contract Attacter {
    ...
    function attack() public payable {
        ...
        console2.log("attacter balance is ", balance);
